...
/**
 * Коллбек, передаваемый в requestAnimationFrame.
 *
 * @param delta Дельта времени между кадрами.
 */
export type RAFCallback = (delta: number) => void
 ...
 */
export const useRAF = (callback: RAFCallback, FPS = 60): void => {
